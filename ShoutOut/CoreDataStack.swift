...
func createMainContext() -> NSManagedObjectContext {
    ...
    let modelURL = Bundle.main.url(forResource: "\(Entity.shoutOut.rawValue)", withExtension: "momd")
    ...
    let storeURL = URL.documentsURL.appendingPathComponent("\(Entity.shoutOut.rawValue).sqlite")
